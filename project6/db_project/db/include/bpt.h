...
// TODO: We limit the file name format to “DATA[NUM]” (e.g., data files should be named like “DATA1”, “DATA2”, ...)
...
// logmsg_path: log message path
// flag: for the recovery test, (0: normal, 1: REDO, 2: UNDO)
// log_num: needed for REDO/UNDO CRASH
// If success, return 0.
